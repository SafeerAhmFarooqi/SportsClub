            ...
            <div class="row">
                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card card-outline-secondary">
                        ...
                        <div class="card-body">
                            <form action="/forgotpassword" method="POST" class="form" role="form" autocomplete="off">
                                @csrf
                                <div class="form-group">
                                    <label for="input_email">Registered Email Address</label>
                                    <input type="text" class="form-control" id="input_email" name="email" value="{{old('email')}}">
                                    
                                </div>
                                <div class="form-group">
                                    <label for="input_mn">Phone Number</label>
                                    <input type="tel" class="form-control" id="input_mn" name="mn" value="{{old('mn')}}">
                                    
                                </div>
                                <div class="form-group">
                                    <label for="input_age">Your Age</label>
                                    <input type="number" class="form-control" id="input_age" name="age" value="{{old('age')}}">
                                    <span style="color: red">
                                    @php
                                        if($pass_error==true)
                                        {
                                            echo "Oops your credentials did not match";
                                        }
                                    @endphp
                                    </span>
                                </div>
